                        ...
                        >
                          {fb.image_path && (
                            <div className="w-full md:w-56 h-56 flex-shrink-0 relative">
                              <img
                                src={`${process.env.REACT_APP_API_URL || 'http://127.0.0.1:8000'}/uploads/${fb.image_path}`}
                                alt="Complaint"
                          ...
                          <div className="grid grid-cols-2 gap-4 mt-auto">
                            {u.work_image_path && (
                              <div className="group relative rounded-3xl overflow-hidden border border-white shadow-lg h-32">
                                <img src={`${process.env.REACT_APP_API_URL || 'http://127.0.0.1:8000'}/uploads/${u.work_image_path}`} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Work" />
                            ...
                            {u.bill_image_path && (
                              <div className="group relative rounded-3xl overflow-hidden border border-white shadow-lg h-32">
                                <img src={`${process.env.REACT_APP_API_URL || 'http://127.0.0.1:8000'}/uploads/${u.bill_image_path}`} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Bill" />
